...
Public Class RegistrationPortal
    ...
    Private Sub btnregistrationexit_Click(sender As Object, e As EventArgs) Handles btnregistrationexit.Click
        Me.Close()
        Application.Exit()
    End Sub

    Private Sub btnPortalexit_Click(sender As Object, e As EventArgs)
